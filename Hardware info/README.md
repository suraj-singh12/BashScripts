Often we need to check the the system details for various various reason and we can use either gui method and this script is a CLI way to check the System and hardware info.
